...
public class ProducerApp {
    public static void main(String[] args) {
        ...
        while(true){
            System.out.println("Bitte geben Sie die Nummer des Hardwarepakets ein:");
            String nummer = read.nextLine();
            ProducerRecord<String, String> rec = new ProducerRecord<String, String>("hardware", "Hardwarepaket " + nummer);
            producer.send(rec);
        }
    }
}
